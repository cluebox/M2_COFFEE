                        ...
                        foreach (string spss_v in spss_variable_name)
                        {
                            if (variable.Name.Equals(spss_v))
                            {
                                ...
                                switch (variable_name)
                                {
                                    ...
                                    case "r25e_300": { ConsP1DTOP_Coffee_Cappuccino = Convert.ToString(record.GetValue(variable)); break; }
                                    case "r25d_300": { ConsP1wTOP_Coffee_Cappuccino = Convert.ToString(record.GetValue(variable)); break; }
                                }
                            }
                        }
                    }
