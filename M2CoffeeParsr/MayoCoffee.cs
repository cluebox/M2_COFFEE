    ...
    class MayoCoffee
    {
        static void Main(string[] args)
        {
         int SurveyID = 600523;
            ...
            //string questions = "r21b_300,r24a_300,r21e_300,r24b_300,r25b_300,r25a_300";
            string[] spss_variable_name = questions.Split(',');
            SpssReader spssDataset;
            using (FileStream fileStream = new FileStream(@"D:\spssparsing\M2Coffee\SPSSW1-54(APRIL2019).sav", FileMode.Open, FileAccess.Read, FileShare.Read, 2048 * 10, FileOptions.SequentialScan))
            {
